    ...
    actions: {
        async search(context, prm) {
            ...
            try {
                ...
                prm.type = ''
                if (context.state.selected_customer_type)
                    prm.type = context.state.selected_customer_type.id
        ...
        async del(context) {
            context.commit("update_search_status", 1)
            try {
                let prm = {token:one_token(),customer_id:context.state.selected_customer.customer_id}
