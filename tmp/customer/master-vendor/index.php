         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <common-navbar></common-navbar>
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <master-vendor-list-mobile v-show="$vuetify.breakpoint.smAndDown"></master-vendor-list-mobile>
                        <master-vendor-list v-show="$vuetify.breakpoint.mdAndUp"></master-vendor-list>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
            ...
            <master-vendor-new></master-vendor-new>
            <master-vendor-filter></master-vendor-filter>
...
computed : {
    ...
    report_url () {
        return this.$store.state.vendor.report_url
    }
},
...
methods : {
   ...
   components: {
        ...
        "master-vendor-list" : httpVueLoader("./components/master-vendor-list.vue?t=<?=date('YmdHis');?>"),
        "master-vendor-list-mobile" : httpVueLoader("./components/master-vendor-list-mobile.vue?t=<?=date('YmdHis');?>"),
        "master-vendor-new" : httpVueLoader("./components/master-vendor-new.vue?t=<?=date('YmdHis');?>"),
        "master-vendor-filter" : httpVueLoader("./components/master-vendor-filter.vue?t=<?=date('YmdHis');?>")
      }
    })
    </script>
    <style>
